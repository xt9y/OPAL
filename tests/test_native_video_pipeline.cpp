...
public:
    bool start(const opal::StreamOptions&) override { started = true; return true; }
...
public:
    bool start(const opal::StreamOptions&, int bitrate) override { started = true; bitrate_kbps = bitrate; return true; }
