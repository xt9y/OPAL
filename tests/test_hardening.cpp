...
int main(){
    ...
    assert(makefile.find("rendezvous-server")!=std::string::npos&&makefile.find("test-peer-session")!=std::string::npos&&makefile.find("test-rendezvous-server")!=std::string::npos);assert(makefile.find("src/net.cpp")==std::string::npos&&makefile.find("direct_video_session.cpp")==std::string::npos&&makefile.find("-lssl")==std::string::npos);
    const auto ci=read_all(".github/workflows/ci.yml");assert(ci.find("workflow_dispatch")!=std::string::npos);assert(ci.find("\n  push:")==std::string::npos);assert(ci.find("test-net")==std::string::npos&&ci.find("test-tunnel-recovery")==std::string::npos&&ci.find("test-direct-video-session")==std::string::npos);assert(ci.find("sanitize")!=std::string::npos&&ci.find("stress")!=std::string::npos);
    return 0;
}
