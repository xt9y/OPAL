...
int main()
{
    ...
    assert(opal::wire_keycode_from_sdl_scancode(4) == opal::wire_key::A);
    assert(opal::wire_keycode_from_sdl_scancode(20) == opal::wire_key::Q);
    assert(opal::wire_keycode_from_sdl_scancode(26) == opal::wire_key::W);
    assert(opal::wire_keycode_from_sdl_scancode(224) == opal::wire_key::LeftCtrl);
    assert(opal::wire_keycode_from_sdl_scancode(9999) == opal::wire_key::None);
    ...
    assert(chord.press_key(opal::wire_key::LeftCtrl));
    assert(chord.press_key(opal::wire_key::LeftAlt));
    assert(chord.press_key(opal::wire_key::LeftShift));
    assert(opal::client_control_chord(chord, opal::wire_key::W) == opal::ClientControlChord::ReleaseCapture);
    assert(opal::client_control_chord(chord, opal::wire_key::Q) == opal::ClientControlChord::Quit);
    assert(opal::client_control_chord(chord, opal::wire_key::A) == opal::ClientControlChord::None);
    chord.release_key(opal::wire_key::LeftShift);
    assert(opal::client_control_chord(chord, opal::wire_key::W) == opal::ClientControlChord::None);
    return 0;
}
