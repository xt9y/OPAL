...
std::mutex auth_mu,input_mu,test_log_mu;SinkProcess input_sink;std::string input_display_key;Paths G;Ini host_cfg;int host_desktop_width=0,host_desktop_height=0;std::atomic<bool>test_close_used{false},session_busy{false};
