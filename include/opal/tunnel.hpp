...
bool tunnel_access(const std::string &control_token,int timeout_ms=30000);
bool tunnel_connection_code(const std::string &code,std::string *control_token=nullptr,std::string *legacy_video_token=nullptr);
